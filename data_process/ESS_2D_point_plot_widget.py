...
class ESS_2D_point_plot_widget(QtGui.QWidget):
    def __init__(self, parent=None, filename="ESS_energy_data20141115_with_pianzhen_100Hz_25"):
        super(ESS_2D_point_plot_widget, self).__init__(parent)
        ...
        self.z_coordinate_doubleSpinBox.setValue(90)
        ...
        self.glayout.addWidget(self.z_coordinate_doubleSpinBox, 2, 1)
    ...
    def plot(self):
        ...
        self.plot_area.axes.set_title(
            self.filename + "\n" + "X=" + str(self.x_coordinate_doubleSpinBox.value()) + " Y=" + str(
                self.y_coordinate_doubleSpinBox.value()))
